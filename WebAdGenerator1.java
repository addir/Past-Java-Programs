...
public class WebAdGenerator1 extends JFrame implements ActionListener {
	// declare and instantiate our objects:
	JPanel panel = new JPanel();
	JButton b = new JButton("Create Ad");

	public WebAdGenerator1() {
		this.add(panel);
	...
	public static void main(String[] args) {
		...
		WebAdGenerator1 frame = new WebAdGenerator1();
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		g.drawString("Price: 199 Dollars", 10, 220);
